...
public class Main {
    ...
    private static boolean ifAnogram(String s1, String s2) {
        ...
        HashMap<Character, Integer> hashMapS1 = (HashMap<Character, Integer>) convertStringToCharHashMap(s1);
        HashMap<Character, Integer> hashMapS2 = (HashMap<Character, Integer>) convertStringToCharHashMap(s2);
